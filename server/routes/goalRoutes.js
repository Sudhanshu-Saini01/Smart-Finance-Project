...
// router.put("/:id/add-funds", auth, async (req, res) => {
//   try {
//     const { amount, sourceType } = req.body; // sourceType can be 'savings' or 'investments'
//     const goal = await Goal.findById(req.params.id);
...
//     if (sourceType === "savings") {
//       goal.fundingSources.fromSavings += parseFloat(amount);
//     } else if (sourceType === "investments") {
//       goal.fundingSources.fromInvestments += parseFloat(amount);
//     }
